            ...
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    ...
                    >
                        ...
                        <g
                            class="duration-750 starting:translate-y-4 starting:opacity-0 translate-y-0 opacity-100 mix-blend-hard-light transition-all delay-300"
                        >
                            <path
                        ...
                        <g
                            class="duration-750 starting:translate-y-4 starting:opacity-0 translate-y-0 opacity-100 mix-blend-plus-darker transition-all delay-300"
                        >
                            <path
